...
export function ERechenungPDF({ order, invoiceNumber }: Props) {
  ...
  return (
    <Document
      ...
      author={SELLER.name}
      subject="E-Rechnung ZUGFeRD 2.3 BASIC"
    >
      <Page size="A4" style={S.page}>
        ...
        <View style={S.letterhead}>
          ...
          <View style={S.lhRight}>
            <View style={S.lhRightBadge}>
              <Text style={S.lhRightBadgeText}>ZUGFeRD 2.3 BASIC</Text>
            </View>
            <Text style={S.lhRightSub}>Factur-X · EN 16931</Text>
          </View>
        </View>
        ...
        <View style={S.zugWrap}>
          <View style={S.zugBadge}>
            <Text style={S.zugBadgeText}>ZUGFeRD</Text>
          </View>
          <Text style={S.zugText}>
            Diese Rechnung enthält eine maschinenlesbare XML-Datei (Factur-X 2.3 BASIC, EN 16931).
            Buchhaltungssoftware wie DATEV oder Lexware kann diese automatisch einlesen.
          </Text>
        </View>
