...
import { SammelrechnungButton } from './SammelrechnungButton';
...
export function SammelrechnungList() {
  ...
  const {
    paginatedItems: paginatedSammelrechnungen,
    currentPage,
    setCurrentPage,
    totalPages
  } = usePagination(sammelrechnungen, { pageSize: 15 });
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {paginatedSammelrechnungen.map((sr) => (
